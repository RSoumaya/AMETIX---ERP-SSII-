		...
		public void send(Candidat candidat, Invitation invitation) throws IOException {
			...
			try {
		        ...
		        //Corps
			        ...
			        String htmlText = "Bonjour Monsieur "+candidat.getNomCandidat()+".<BR></BR><BR></BR><BR></BR>Suite à notre conultation de votre profil, nous souhaitons vous inviter dans nos locaux pour vous inviter à passer un entretien le : "+invitation.getStartdate()+"<BR></BR><BR></BR>"
